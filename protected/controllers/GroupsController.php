...
class GroupsController extends AdminController
{
	...
	public function actionIndex()
	{
		...
		$users = CHtml::listData($models, 'id', 'name');
	...
	{
		$model=UsersGroups::model()->findByPk($_POST['model_id']);
	...
	{
		$model=UsersGroups::model()->find('user_id='.$_POST['user_id'].' && '.'group_id='.$_POST['group_id']);
		...
		if( isset($model) ){
			...
			if($model->save()){
				echo '["done", '.$model->id.', "'.$model->user->name.'"]';
			}else{
				echo '["error"]';
			}
		}
